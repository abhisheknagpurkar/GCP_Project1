...
bq_station_table_name = "stations"
bq_stations_table_id = f"{gcp_project_id}.{bq_raw_dataset}.{bq_station_table_name}"
...
bq_trips_table_schema = "data/schema/trips_schema.json"
...
with DAG(
    ...
    gcs_to_bq_station = GoogleCloudStorageToBigQueryOperator(
        ...
        schema_object=bq_stations_table_schema,
    ...
    gcs_to_bq_region = GoogleCloudStorageToBigQueryOperator(
        ...
        schema_object=bq_regions_table_schema,
        schema_object_bucket="us-east4-airflowinstance1-971d22b7-bucket",
        write_disposition="WRITE_TRUNCATE",
    )
    ...
    ### Load Data Mart ###
    export_mysql_station >> gcs_to_bq_station >> send_dag_success_signal
