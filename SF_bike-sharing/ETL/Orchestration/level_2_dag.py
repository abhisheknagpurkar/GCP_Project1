...
EXPORT_URI = (
    "gs://deongcp-data-bucket/mysql_exports/from_composer/stations/stations.csv"
)
...
with DAG(
    ...
    gcs_to_bq_example = GoogleCloudStorageToBigQueryOperator(
        ...
        bucket="deongcp-data-bucket",
        source_objects=["mysql_exports/from_composer/stations/stations.csv"],
